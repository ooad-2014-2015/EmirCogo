...
namespace eRestoran
{
    public partial class App : Application
    {
        ...
        private void Application_Launching(object sender, LaunchingEventArgs e)
        {
            ...
            if (isoStore.FileExists("mojFile.txt"))
            {
                StreamReader sr = new StreamReader(isoStore.OpenFile("mojFile.txt", FileMode.Open));
        ...
        private void Application_Activated(object sender, ActivatedEventArgs e)
        {
            ...
            if (PhoneApplicationService.Current.State.ContainsKey("ApplicationDataObject"))
            {
                ...
                mojAtribut = PhoneApplicationService.Current.State["ApplicationDataObject"] as string;
            }
        }
